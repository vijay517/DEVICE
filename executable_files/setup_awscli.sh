...
#-----------------------------------------------------------------------------------------------------
#			STEP 2: CHECKING IF keys.csv AND deviceinfo.txt FILES ARE PRESENT
#-----------------------------------------------------------------------------------------------------
...
wget https://www.amazontrust.com/repository/AmazonRootCA1.pem -O $ROOTDIR/certificates/root.ca.pem
